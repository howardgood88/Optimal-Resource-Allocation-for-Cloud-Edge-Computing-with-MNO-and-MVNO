...
plot_2d('mno_block_rate', 'MNO/', 'MNO task block ratio', 'block ratio', 'task_block_rate')
plot_2d('mvno_block_rate', 'MVNO/', 'MVNO task block ratio', 'block ratio', 'task_block_rate')
