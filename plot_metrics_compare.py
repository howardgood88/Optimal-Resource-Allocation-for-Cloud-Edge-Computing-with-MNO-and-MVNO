...
plot_1d('mvno_vm_cost', 'MVNO VM cost', 'round', 'VM total cost(NTD)', 'MVNO/vm_cost', plot_2dim_line, None)
plot_2d('mno_task_fitness', 'MNO/', 'average task utility of MNO in busy days', 'average utility', 'task_fitness', (0, 100))
plot_3x3('mno_task_resource', 'MNO/', 'MNO task', 'hour', 'task_resource', None)
plot_2d('mvno_task_fitness', 'MVNO/', 'average task utility of MVNO in busy days', 'average utility', 'task_fitness', (0, 100))
...
plot_1d('mno_user_cost', 'MNO average user cost in busy days', 'hour', 'average user cost(NTD)', 'MNO/user_cost', plot_2dim_line, None)
plot_1d('mvno_user_cost', 'MVNO average user cost in busy days', 'hour', 'average user cost(NTD)', 'MVNO/user_cost', plot_2dim_line, None)
