...
def beta_test():
    ...
    plt.title('User to VM throughput generation (beta distribution)')
    ...
    plt.figure(figsize=figsize)
    plt.title('VoIP uplink throughput generation (beta distribution)')
    ...
    plt.figure(figsize=figsize)
    plt.title('VoIP downlink throughput generation (beta distribution)')
    plt.xlabel('throughput(Kbps)')
    plt.ylabel('times')
    ...
    plt.figure(figsize=figsize)
    plt.title('IP VIdeo uplink throughput generation (beta distribution)')
    plt.xlabel('throughput(Kbps)')
    plt.ylabel('times')
    ...
    plt.figure(figsize=figsize)
    plt.title('IP VIdeo downlink throughput generation (beta distribution)')
    plt.xlabel('throughput(Kbps)')
    plt.ylabel('times')
    ...
    plt.figure(figsize=figsize)
    plt.title('FTP uplink throughput generation (beta distribution)')
    plt.xlabel('throughput(Kbps)')
    plt.ylabel('times')
    ...
    plt.figure(figsize=figsize)
    plt.title('FTP downlink throughput generation (beta distribution)')
    plt.xlabel('throughput(Kbps)')
    plt.ylabel('times')
...
def PT5_test():
    ...
    plt.xlabel('delay(ms)')
    plt.ylabel('times')
    plt.title('User to cloud VM throughput generation (PT5 distribution)')
    ...
    plt.xlabel('delay(ms)')
    plt.ylabel('times')
    plt.title('User to edge VM throughput generation (PT5 distribution)')
